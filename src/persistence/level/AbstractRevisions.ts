import { IUser, IListResponse, IListOptions, IRevision } from '@api-client/core';
...
export interface IRevisionsStore {
  ...
  list(key: string, user: IUser, alt?: AltType, options?: IListOptions): Promise<IListResponse<IRevision>>;
}
